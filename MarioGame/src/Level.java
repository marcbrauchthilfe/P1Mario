...
public class Level {
    ...
    private int[][] enemyPositions = new int[0][0];
    ...
    public static Level createSampleLevel(int index) {
        // größere Breite für längere Level
        Level level = new Level((int) (5000 * Zoom.SCALE), (int) (800 * Zoom.SCALE));
        ArrayList<Tile> tiles = new ArrayList<>();

        int spawnY = groundY - TILE_SIZE;

        // 1) Anfangsgrundboden: sehr lang, später entfernen wir gezielt Bereiche
        int groundTiles = 160; // ausreichend lang
